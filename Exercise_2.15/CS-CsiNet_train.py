...
def residual_network(encoded, residual_num, encoded_dim):
    ...
    decoded = Reshape((img_height, img_width, img_channels,))(decoded)  # Reshape to 4D CSI tensor
    for i in range(residual_num):
        decoded = residual_block_decoded(decoded)  # Stack residual blocks for high-quality reconstruction
    
    decoded = Conv2D(2, (3, 3), activation='sigmoid', padding='same', data_format="channels_last")(decoded)
    return decoded
